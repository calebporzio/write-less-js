<template>
    <div class="Box Box--blue">
        ...
        <code-row file="app" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="config" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="bootstrap" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="storage" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="resources" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="routes" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="bin" commit="Update PULL_REQUEST_TEMPLATE.md"/>
        <code-row file="tests" commit="Update PULL_REQUEST_TEMPLATE.md"/>
    </div>
</template>
